#### Pantalla Locking Pins Settings

Esta pantalla muestra y permite controlar la lista de parámetros de los pasadores de bloqueo del eje de elevación.

![](../Resources/media/image103.png)

*Figura 2‑87. Pantalla locking pins settings.*
...
<tr class="odd">
<td>1</td>
<td>Muestra la lista de parámetros de los pasadores de bloqueo del eje de elevación.</td>
</tr>
<tr class="even">
<td>2</td>
<td><p>Permite modificar los valores de los parámetros de las diferentes instancias.</p>
<p>Desplegable “Instance”: Permite seleccionar la instancia deseada del subsistema, en este caso es el Locking Pin X- o
X+.</p>
