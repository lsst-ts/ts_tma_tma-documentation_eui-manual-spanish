#### Pantalla Deployable Platform Settings

Esta pantalla muestra y permite controlar la lista de parámetros de las plataformas desplegables.

![](../Resources/media/image109.png)

*Figura 2‑93. Pantalla deployable platform settings.*
...
<tr class="odd">
<td>1</td>
<td>Muestra la lista de parámetros de las plataformas desplegables.</td>
</tr>
<tr class="even">
<td>2</td>
<td><p>Permite modificar los valores de los parámetros de las diferentes instancias.</p>
<p>Desplegable “Instance”: Permite seleccionar la instancia deseada del subsistema, en este caso son las plataformas
desplegables.</p>
